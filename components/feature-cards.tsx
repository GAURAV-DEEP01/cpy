...
const features = [
  {
    ...
    description: "Generate and share content in seconds with our optimized platform.",
    bgColor: "bg-violet-900/30",
    iconColor: "text-violet-400",
    iconPath: "M13 10V3L4 14h7v7l9-11h-7z",
  },
  {
    title: "Content available up to 24 hrs",
  ...
  },
  {
    ...
    description: "Share code, links, and images - all with the same simple interface.",
...
export const FeatureCards: React.FC = () => {
  return (
    <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
      {features.map(({ title, description, bgColor, iconColor, iconPath }, index) => (
        <div
          key={title}
          className={`rounded-lg bg-gray-800/90 p-6 transition-all hover:bg-gray-800 ${index === 2 ? "sm:col-span-2 lg:col-span-1" : ""}`}
        >
          <div className={`mb-4 rounded-full ${bgColor} p-3 w-12 h-12 flex items-center justify-center`}>
