    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <div className="container relative mx-auto px-4 py-16">
        ...
        <div className="flex flex-col items-center justify-center space-y-6 text-center">
          <div className="mb-2 inline-block rounded-lg bg-gray-800 p-2">
          ...
          <p className="max-w-[600px] text-gray-400">
            Share code snippets, links, and images with short, 4-letter URLs.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 max-w-3xl rounded-xl bg-gray-800/50 p-6 backdrop-blur-sm">
          <Tabs defaultValue="code" className="w-full">
            <TabsList className="grid w-full grid-cols-3 rounded-lg bg-gray-900/50">
              <TabsTrigger
                value="code"
              ...
              <TabsTrigger
                value="image"
                className="data-[state=active]:bg-gray-700 data-[state=active]:text-emerald-400"
              >
                <svg className="mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <div className="mt-24 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg bg-gray-800/50 p-6 transition-all hover:bg-gray-800">
          ...
          <div className="rounded-lg bg-gray-800/50 p-6 transition-all hover:bg-gray-800">
            ...
            <p className="mt-2 text-gray-400">Your content is encrypted and can be password protected.</p>
          </div>

          <div className="rounded-lg bg-gray-800/50 p-6 transition-all hover:bg-gray-800 sm:col-span-2 lg:col-span-1">
      ...
      <footer className="mt-20 border-t border-gray-800 py-8">
        <div className="container mx-auto px-4 text-center text-sm text-gray-500">
          <p>© 2025 to.deeeep.fun. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
